...
<body>
    ...
    <div class="book-list">
        ...
        <div class="book-item">
            <img src="/IMG/habitosatomicos.jpg" alt="Nome do livro"> 
            <div class="text-list">
                <h1>Habitos atomicos</h1>
            <p>48 unidades disponiveis</p>
            </div>

        </div>
        <div class="book-item">
            <img src="/IMG/arte da guerra.jpg" alt="Nome do livro">
           
            <div class="text-list">
                <h1>Arte da guerra</h1>
            <p>48 unidades disponiveis</p>
            </div>
        </div>
        <div class="book-item">
            <img src="/IMG/as 48 leis do poder.jpg" alt="Nome do livro">
            <div class="text-list">
        ...
        <div class="book-item">
            <img src="/IMG/maestri.jpg" alt="Nome do livro">
            <div class="text-list">
                <h1>Maestria</h1>
            <p>48 unidades disponiveis</p>
            </div>
